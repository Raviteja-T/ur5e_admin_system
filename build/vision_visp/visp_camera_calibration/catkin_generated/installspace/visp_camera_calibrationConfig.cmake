...
if(NOT "include;/opt/ros/noetic/include;/usr/include/opencv4;/usr/include/eigen3;/usr/include/libxml2;/usr/include;/usr/include/OGRE;/usr/include/ois " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'visp_camera_calibration' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '\${prefix}/${idir}'.  ${_report}")
    endif()
