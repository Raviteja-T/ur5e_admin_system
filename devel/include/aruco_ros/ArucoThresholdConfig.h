...
namespace aruco_ros
{
  ...
  public:
    ...
    public:
      ...
      virtual void clamp(ArucoThresholdConfig &config, const ArucoThresholdConfig &max, const ArucoThresholdConfig &min) const override
      {
      ...
      virtual void calcLevel(uint32_t &comb_level, const ArucoThresholdConfig &config1, const ArucoThresholdConfig &config2) const override
      {
        if (config1.*field != config2.*field)
          comb_level |= level;
      }

      virtual void fromServer(const ros::NodeHandle &nh, ArucoThresholdConfig &config) const override
      {
        nh.getParam(name, config.*field);
      }

      virtual void toServer(const ros::NodeHandle &nh, const ArucoThresholdConfig &config) const override
      {
        nh.setParam(name, config.*field);
      }

      virtual bool fromMessage(const dynamic_reconfigure::Config &msg, ArucoThresholdConfig &config) const override
      {
        return dynamic_reconfigure::ConfigTools::getParameter(msg, name, config.*field);
      }

      virtual void toMessage(dynamic_reconfigure::Config &msg, const ArucoThresholdConfig &config) const override
      {
        dynamic_reconfigure::ConfigTools::appendParameter(msg, name, config.*field);
      }

      virtual void getValue(const ArucoThresholdConfig &config, boost::any &val) const override
      {
        val = config.*field;
      }
    };
    ...
    public:
      ...
      virtual void updateParams(boost::any &cfg, ArucoThresholdConfig &top) const override
      {
        PT* config = boost::any_cast<PT*>(cfg);
