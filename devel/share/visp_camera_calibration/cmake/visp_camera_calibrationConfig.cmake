...
if("TRUE" STREQUAL "TRUE")
  set(visp_camera_calibration_SOURCE_PREFIX /home/toor/catkin_ws/src/vision_visp/visp_camera_calibration)
  set(visp_camera_calibration_DEVEL_PREFIX /home/toor/catkin_ws/devel)
  ...
  set(visp_camera_calibration_INSTALL_PREFIX /home/toor/catkin_ws/install)
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT visp_camera_calibration_NUM_DUMMY_TARGETS)
      set(visp_camera_calibration_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::visp_camera_calibration::wrapped-linker-option${visp_camera_calibration_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR visp_camera_calibration_NUM_DUMMY_TARGETS "${visp_camera_calibration_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::visp_camera_calibration::wrapped-linker-option${visp_camera_calibration_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND visp_camera_calibration_LIBRARIES "${interface_target_name}")
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(visp_camera_calibration_EXPORTED_TARGETS ${${visp_camera_calibration_dep}_EXPORTED_TARGETS})
endforeach()
