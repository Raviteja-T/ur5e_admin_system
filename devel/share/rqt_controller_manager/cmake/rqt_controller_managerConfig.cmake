...
if("TRUE" STREQUAL "TRUE")
  set(rqt_controller_manager_SOURCE_PREFIX /home/toor/catkin_ws/src/ros_control/rqt_controller_manager)
  set(rqt_controller_manager_DEVEL_PREFIX /home/toor/catkin_ws/devel)
  ...
  set(rqt_controller_manager_INSTALL_PREFIX /home/toor/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rqt_controller_manager' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/toor/catkin_ws/src/ros_control/rqt_controller_manager/${idir}'.  ${_report}")
    endif()
